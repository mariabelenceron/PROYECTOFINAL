...
<html>
    <%
        HttpSession sesionSG = request.getSession();
        HashMap<String, Integer> roles = (HashMap) sesionSG.getAttribute("ROLES");
    %>
    <head>
    ...
    <body>
        <div id="sidebar-container" class="bg-primary">
            ...
            <div class="menu">
                ...
                <div class="hover-sidebar">
                    <a href="../vistas/Auditoria.jsp" class="d-block text-light p-3 border-0"
