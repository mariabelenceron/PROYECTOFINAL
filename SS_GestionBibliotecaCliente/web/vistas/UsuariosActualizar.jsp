            ...
            <div class="w-100">
                ...
                <section id="content" class="bg-light w-100">
                    <div class="container">
                        ...
                        String codigo = request.getParameter("idC");
                        Usuario u = uDao.buscarID(codigo.trim());
                        RolUsuarioDao rol = new RolUsuarioDao();
                        HashMap<String, Integer> rolesE = rol.roles(u.getCodigo().trim());
                        %>
                        <!-- Formulario  -->
                        <div class="col-12">
                            <form id="formularioRegistrarUsuario" action="../ControladorUsuario" method="POST" >
                                <div class="form-group row">
                                    <div class="col-6 mb-1" id="grupo_codigoUsuario">
                                        ...
                                        <div class="col-auto">
                                            <input type="text" id="codigoUsuario" name="codigoUsuario" value = <%=u.getCodigo() %> class="form-control" placeholder="Ingrese el codigo" required>
                                        </div>
                                    </div>
                                    <div class="col-6 mb-1" id="grupo_cedulaUsuario">
                                        <label class="pb-0 col-auto col-form-label" for="cedulaUsuario">Cedula:</label>
                                        <div class="col-auto">
                                            <input type="text" id="cedulaUsuario" name="cedulaUsuario" class="form-control" value = <%=u.getCedula() %> placeholder="Ingrese el numero de cedula" required>
                                        </div>
                                    </div>
                                    <div class="col-12 mb-1" id="grupo_nombreUsuario">
                                        ...
                                        <div class="col-auto">
                                            <input type="text" id="nombreUsuario" name="nombreUsuario" class="form-control" value = <%=u.getNombre() %> placeholder="Ingrese el nombre completo" required>
                                        </div>
                                    </div>
                                    <div class="col-12 mb-1" id="grupo_correoUsuario">
                                        <label class="pb-0 col-auto col-form-label" for="correoUsuario">Correo:</label>
                                        <div class="col-auto">
                                            <input type="text"  id="correoUsuario" name="correoUsuario" class="form-control" value = <%=u.getCorreo() %> placeholder="Ingrese el usuario" required>
                                        </div>
                                    </div>
                                    <div class="col-6 mb-1" id="grupo_sesionDesdeUsuario">
                                        ...
                                        <div class="col-auto">
                                            <input type="text"  id="sesionDesdeUsuario" name="sesionDesdeUsuario" class="form-control" value = <%=u.getDesde() %> placeholder="00:00:00" required>
                                        </div>
                                    </div>
                                    <div class="col-6 mb-1" id="grupo_sesionHastaUsuario">
                                        ...
                                        <div class="col-auto">
                                            <input type="text" id="sesionHastaUsuario" name="sesionHastaUsuario" class="form-control" value = <%=u.getHasta() %> placeholder="00:00:00" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <center>
                                    ...
                                    <button type="submit" name="accion" value="Actualizar" id="btnRegistrar" class="btn btn-primary"> Registrar</button>
                                </center>
                            </form>
                        </div><!--Fin Formulario  -->
